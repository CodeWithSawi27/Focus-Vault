...
import {
  ArrowLeft, Database, Fingerprint,
  Trash2, Shield, Lock,
...
const DATA_ITEMS: DataItem[] = [
  {
    ...
    description: 'Email address and display name stored securely via Firebase Authentication.',
  },
  {
    icon: Database,
    title: 'Habits & Logs',
    description: 'Your habits, completion logs, and streak data stored in our secure database.',
  },
  {
    icon: Shield,
    title: 'Focus Sessions',
    description: 'Session duration, category, notes, and timestamps stored per session.',
  },
  {
    icon: Lock,
    title: 'No Third-Party Sharing',
    description: 'Your data is never sold or shared with third-party advertisers.',
  },
];
...
export default function PrivacyScreen() {
  ...
  const performDelete = async () => {
    ...
    try {
      ...
      // Auth listener in root layout will redirect to login automatically
    } catch (e: any) {
      setDeleting(false);
      Alert.alert(
        'Delete Failed',
      ...
      >
        ...
        <View style={styles.introCard}>
          ...
          <Text style={styles.introSubtitle}>
            ...
            Here is a full breakdown of what we store.
          </Text>
        </View>
